...
<script type="text/javascript" src="js/admi8.js"></script>
    ...
    <body onload="regresarIndex();" class="is-preload">
        <br>
        <br>
    <center>
        <header id="header">
		...
		<!-- Footer -->
			<footer id="footer">
				<ul class="icons">
					...
					<li><a href="https://www.facebook.com/Optica-Visual-ABC-107733947754627" class="icon brands fa-github"><span class="label">f</span></a></li>
